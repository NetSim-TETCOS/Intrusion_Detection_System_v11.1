...
#ifdef _IDS_
	#define _IDS_METRIC_INIT
	_declspec(dllexport)int mal_dev_count;
	_declspec(dllexport)int mal_devid[100];
	_declspec(dllexport)double mal_start_time[100];
	_declspec(dllexport)double mal_det_time[100];
#endif
	/* Packet Size */
